...
caminho = r"E:\elo group\tabela receita acumulada.jpg"

# Abre a imagem 
tabelarec = Image.open(caminho)
...
import pytesseract  # Ferramenta que converte imagem em texto
import cv2  
...
imagem = cv2.imread(r"E:\elo group\tabela receita acumulada.jpg")
